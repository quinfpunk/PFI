...
class ReducedCNN(nn.Module):
    def __init__(self, original_model, target_class, img_height=128, img_width = 128):
        ...
        self.conv3.bias.data = original_model.conv3.bias #keep the original biases (128)
...
if __name__ == "__main__":
    ...
    sample_input = torch.randn(1, 3, 128, 128)  # Example input size (batch_size, channels, height, width)
    output = reduced_model(sample_input)
